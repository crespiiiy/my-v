...
export const products: Product[] = [
  ...
  {
    id: "12",
    name: "Python Pro: Zero to Mastery",
    description: "Learn Python from scratch. Master object-oriented programming, automation, web scraping, data science basics, and building real-world applications. Perfect for beginners and intermediate programmers.",
    price: 89.99,
